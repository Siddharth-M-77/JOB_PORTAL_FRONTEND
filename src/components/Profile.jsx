...
const Profile = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto bg-white h-[80vh] flex  flex-col justify-start shadow-lg rounded-lg my-5 p-8">
      <div className="flex  gap-8 justify-between p-6">
        <div className="flex gap-2 items-center">
          ...
          <div className="">
            <h1 className="font-extrabold text-xl">SIddharth</h1>
            <p className="w-[40vw] opacity-65 text-sm">
              Lorem ipsum dolor sit, amet consectetur adipisicing elit. Sequi
              culpa officia, in dolore d
            </p>
          </div>
        </div>
        <Button>
      ...
      <div className="grid w-full max-w-sm items-center">
        ...
        {isHaveResume ? (
          <a target="_blank" href="" className="text-blue-600 hover:underline cursor-pointer">
            Resume
          </a>
        ) : (
          "NA"
